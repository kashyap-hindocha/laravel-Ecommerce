    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
 <form action="{{route('/adduser')}}" method="post" name="add">
        @csrf
...
<div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                <br>
                                <input id="male" type="radio" class="@error('gender') is-invalid @enderror" name="gender" value="Male" required autofocus> Male
