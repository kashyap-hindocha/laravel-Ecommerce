<!--Header-part-->
<div id="header">
  <h1><a href="<?php echo e(url('/admin/dashboard')); ?>">Laravel Admin</a></h1>
</div>
<!--close-Header-part--> 
...
<div id="user-nav" class="navbar navbar-inverse">
  ...
  <li class=""><a title="" href="<?php echo e(url('/admin/settings')); ?>"><i class="icon icon-cog"></i> <span class="text">Settings</span></a></li>
    ...
    <li class=""><a title="" target="_blank" href="<?php echo e(url('/')); ?>"><i class="icon icon-site"></i> <span class="text">Visit Site</span></a></li>
  </ul>
</div>
