      ...
      <div class="row-fluid">
        <div class="span12">
          <div class="widget-box">
            ...
            <form class="form-horizontal" method="post" action="<?php echo e(url('/admin/add-category')); ?>"
             name="add_category" id="add_category" novalidate="novalidate"> <?php echo e(csrf_field()); ?>
