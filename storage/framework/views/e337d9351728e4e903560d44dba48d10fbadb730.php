...
<div id="breadcrumb"> <a href="index.html" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a>
  <a href="#">Categories</a> <a href="#" class="current">Edit Category</a> </div>
<h1>Categories</h1>
</div>
...
<div class="row-fluid">
  <div class="span12">
    <div class="widget-box">
      ...
      <form class="form-horizontal" method="post" action="<?php echo e(url('/admin/edit-category/'.$categoryDetails->id)); ?>"
        name="edit_category" id="edit_category" novalidate="novalidate"> <?php echo e(csrf_field()); ?>
          ...
          <div class="control-group">
              ...
              <div class="controls">
                <textarea name="description" id="description"><?php echo e($categoryDetails->Description); ?> </textarea>
              </div>
            </div>
          <div class="control-group">
